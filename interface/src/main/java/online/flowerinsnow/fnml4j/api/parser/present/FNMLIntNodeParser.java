 ...
 * <p>将字符串节点解析为整数类型</p>
 */
public class FNMLIntNodeParser extends FNMLStringNodeParser<Integer> {
    @Override
    public @Nullable Integer parse(@NotNull FNMLStringNode node) throws NodeParseException {
        try {
